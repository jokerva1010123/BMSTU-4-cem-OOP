...
QT_MOC_LITERAL(1, 7, 13), // "floor_pressed"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7), // "ssize_t"
QT_MOC_LITERAL(4, 30, 5), // "floor"
QT_MOC_LITERAL(5, 36, 14), // "unpress_signal"
QT_MOC_LITERAL(6, 51, 7), // "pressed"
QT_MOC_LITERAL(7, 59, 9) // "unpressed"

    },
    "button\0floor_pressed\0\0ssize_t\0floor\0"
    "unpress_signal\0pressed\0unpressed"
};
...
void button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->floor_pressed((*reinterpret_cast< ssize_t(*)>(_a[1]))); break;
        case 1: _t->unpress_signal(); break;
        case 2: _t->pressed(); break;
        case 3: _t->unpressed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (button::*)(ssize_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&button::floor_pressed)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&button::unpress_signal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void button::floor_pressed(ssize_t _t1)
{
